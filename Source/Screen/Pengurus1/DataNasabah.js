...
import {styles} from '../../Style/Pengurus1/DataNasabahStyle';
import AsyncStorage from '@react-native-community/async-storage';

export default class DataNasabah extends Component {
  constructor() {
    super();
    this.state = {
      isLoading: false,
  ...
  getNasabah() {
    ...
    fetch('https://qualcoom.herokuapp.com/api/pengurus/user', {
      method: 'GET',
      headers: {
        ...
        <ScrollView
          ...
          {this.state.dataSource.map((val) => {
            return (
              <TouchableOpacity
                onPress={() =>
                  this.props.navigation.navigate('Setoran', {
                    getPro: val,
                  })
                }
                style={styles.kontak}>
